...
/**
 * FuelPHP_Sniffs_WhiteSpace_DisallowTabIndentSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class FuelPHP_Sniffs_WhiteSpace_DisallowTabIndentSniff
...
//            $phpcsFile->addError($error, $stackPtr, 'NonIndentTabsUsed');
//        }
        $tokens    = $phpcsFile->getTokens();
        $error     = 'Spaces must be used to indent lines; tabs are not allowed';
        $errorCode = 'TabsUsed';
