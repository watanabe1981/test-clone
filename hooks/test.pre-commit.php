...
<?php
/**
* The Git Hook Tools Script.
*
* @package    GitHook
* @version    1.0
* @author     i.watanabe@developpers.info
* @license    MIT License
* @copyright  2016 developpers.info
* @category   GIT Hook
*/
...
$included = include((file_exists(realpath($file_path)) ? realpath($file_path) : __DIR__.'/../../../autoload.php'));
...
use SitePoint\StaticReview\PHP\VarDumpReview;
use SitePoint\StaticReview\PHP\FuelPhpCodeSnifferReview;
...
/**
 * Checks if the file contains any CRLFine endings
 * Checks if the set file starts with the correct character sequence
 * Checks if the file contains NOCOMMIT.
 * Checks PHP files using the built-in PHPinter, php -l.
...
$review->addReview(new LineEndingsReview())
       ...
       ->addReview(new FuelPhpCodeSnifferReview())
